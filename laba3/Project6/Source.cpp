...
public:
    ...
    std::vector<Edge> shortest_path(const Vertex& from, const Vertex& to) const {
        std::unordered_map<Vertex, Distance> distances;//кратч расст
        std::unordered_map<Vertex, Vertex> previous;//инфу хранит о пред
...
// Демонстрация работы класса Graph и решение задачи
int main() {
